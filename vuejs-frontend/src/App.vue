...
export default {
  ...
  methods: {
    ...
    async fetchPosts() {
      this.loading = true
      const response = await axios.get('http://workshop2.bchwy.com/2read.php')
      this.posts = response.data
      this.loading = false
    },

    async addPost() {
      const response = await axios.post('http://workshop2.bchwy.com/1create.php', this.newPost, {
        headers: {
    ...
    async deletePost(id) {
      await axios.post('http://workshop2.bchwy.com/4delete.php', { id }, {
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      });
    ...
    async updatePost(updatedPost) {
      await axios.post('http://workshop2.bchwy.com/3update.php', updatedPost, {
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        }
      });
